...
const AUTH_ERROR_PRESENTATIONS: Record<string, AuthErrorPresentation> = {
  ACCOUNT_SELF_DEACTIVATED: {
    ...
    message: 'Dieses Konto wurde zuvor selbst deaktiviert. Eine Anmeldung ist derzeit nicht möglich.',
  ...
  OAUTH_EMAIL_CONFLICT: { message: 'Zu dieser E-Mail-Adresse existiert bereits ein Konto. Bitte melden Sie sich zuerst mit Ihrem Passwort an und verknüpfen Sie den Anbieter anschließend im Profil.' },
  ...
  INVALID_OAUTH_STATE: { message: 'Die externe Anmeldung ist abgelaufen. Bitte versuchen Sie es erneut.' },
  OAUTH_LOGIN_FAILED: { message: 'Die externe Anmeldung konnte nicht abgeschlossen werden.' },
  AUTH_REQUIRED: { message: 'Bitte melden Sie sich zuerst an.' }
}
