<template>
  <section class="rounded-2xl border border-rose-200 bg-rose-50/50 p-5 sm:p-6" aria-labelledby="polygon-danger-heading">
    ...
    <button class="mt-5 inline-flex min-h-11 cursor-pointer items-center gap-2 rounded-xl border border-rose-300 bg-white px-4 text-sm font-bold text-rose-700 transition hover:bg-rose-100 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-rose-700" type="button" @click="dialogOpen = true">
