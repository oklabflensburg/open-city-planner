<template>
  <Card class="p-4">
    <div><p class="civic-kicker">Struktur &amp; Datenqualität</p><h2 class="mt-1 text-sm font-extrabold text-[var(--c-text)]">Gefilterte Flächen im Überblick</h2><p class="mt-1 text-[11px] text-[var(--c-text-muted)]">Berechnet aus gepflegten Stadtplanner-Flächen</p></div>
