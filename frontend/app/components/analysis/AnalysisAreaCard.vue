<template>
  <section v-if="area" class="rounded-2xl border border-slate-200 bg-white p-4 shadow-sm" aria-labelledby="analysis-area-title">
    <div class="flex items-start justify-between gap-3">
      ...
      <button class="grid size-9 shrink-0 place-items-center rounded-lg text-slate-500 hover:bg-slate-100" type="button" aria-label="Gebietsauswahl schließen" @click="store.clearSelection()">
