    ...
    def render(self, event: DomainEvent) -> NotificationSpec:
        ...
        policies: dict[NotificationEventType, NotificationSpec] = {
            ...
            NotificationEventType.GIS_AREA_DELETED: NotificationSpec(
                ...
                "WARNING",
                "Fläche gelöscht",
                "Eine von Ihnen beobachtete oder verwaltete Fläche wurde gelöscht.",
                "/",
                "Karte öffnen",
                "area-delete",
            ),
            ...
            NotificationEventType.ROLE_ASSIGNED: NotificationSpec(
                ...
                "INFO",
                "Rolle vergeben",
                f"Ihrem Konto wurde die Rolle {role} zugewiesen.",
                "/profil/sicherheit",
                "Sicherheit öffnen",
                "role-assigned",
            ),
            NotificationEventType.ROLE_REMOVED: NotificationSpec(
                ...
                "WARNING",
                "Rolle entfernt",
                f"Die Rolle {role} wurde Ihrem Konto entzogen.",
                "/profil/sicherheit",
                "Sicherheit öffnen",
                "role-removed",
            ),
            NotificationEventType.ACCOUNT_DEACTIVATED: NotificationSpec(
                ...
                "WARNING",
                "Konto deaktiviert",
                "Ihr Konto wurde durch die Administration deaktiviert.",
                "/login",
                "Zur Anmeldung",
                "account-deactivated",
            ),
            NotificationEventType.ACCOUNT_REACTIVATED: NotificationSpec(
                ...
                "SUCCESS",
                "Konto reaktiviert",
                "Ihr Konto wurde wieder aktiviert.",
                "/profil",
                "Profil öffnen",
                "account-reactivated",
            ),
